...
public class BigDecimalMaximumCollectorTest {
    ...
    void testEmpty() {
        ...
        assertThat(stream.parallel().collect(new BigDecimalMaximumCollector())).isEqualTo(null);
    }

    @Test
    void testValue1() {
        Stream<BigDecimal> stream = Stream.of(new BigDecimal("1000"));
        assertThat(stream.parallel().collect(new BigDecimalMaximumCollector())).isEqualTo(new BigDecimal("1000"));
    }
    ...
    void testValueN() {
        ...
        assertThat(stream.parallel().collect(new BigDecimalMaximumCollector())).isEqualTo(new BigDecimal("999"));
    }
