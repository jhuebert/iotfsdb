...
public class MaximumCollectorTest {

    @Test
    void testEmpty() {
        Stream<Double> stream = Stream.empty();
        assertThat(stream.parallel().collect(new MaximumCollector())).isEqualTo(null);
    }

    @Test
    void testValue1() {
        Stream<Double> stream = Stream.of(1000.0);
        assertThat(stream.parallel().collect(new MaximumCollector())).isEqualTo(1000.0);
    }
    ...
    void testValueN() {
        ...
        assertThat(stream.parallel().collect(new MaximumCollector())).isEqualTo(999.0);
    }
